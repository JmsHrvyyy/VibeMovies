...
const AiDiscover = ({ user }) => {
  ...
  const handleAiSearch = async (e) => {
    ...
    try {
      ...
      setStatusText("Cross-referencing AI recommendations with movie database...");
      ...
      if (tmdbResults.length === 0) {
        setStatusText("❌ Walang nahanap na tugmang pelikula sa database.");
      } else {
        setStatusText("");
      }
      ...
      setStatusText("Error in AI discovery. Please try again later or check your input.");
    } finally {
      setLoading(false);
    }
  };
    ...
    <div className="min-h-screen bg-[#080d17] text-white p-6 md:p-12 max-w-6xl">
      ...
      <div className="mb-10">
        ...
        <p className="text-xs text-gray-500 mt-1">
            Describe the vibe or plot you're looking for, and let AI surprise you with movie recommendations!
        </p>
      </div>
        ...
        <form onSubmit={handleAiSearch} className="space-y-4">
          <div className="flex flex-col gap-2">
            ...
            <textarea
              ...
              placeholder='Example: "A mind-bending sci-fi movie with a shocking plot twist" o kaya "Romcom na nakakaiyak pero may aso"...'
      ...
      {statusText && (
        <div className="flex flex-col items-center justify-center py-12 text-center">
          ...
          <p className="text-sm font-bold text-gray-400 italic tracking-wide">{statusText}</p>
        </div>
      )}
      ...
      {movies.length > 0 && (
        <div className="space-y-6">
          <h2 className="text-xs font-black uppercase tracking-widest text-blue-400 pl-1">
